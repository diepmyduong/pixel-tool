...
interface AnimationSetupPanelProps {
...
export default function AnimationSetupPanel({
  characterId,
  onCharacterIdChange,
  itemIds,
  onItemIdsChange,
  ...
  return (
    <Card title="Setup">
      <Space direction="vertical" style={{ width: '100%' }} size="middle">
        ...
        <Typography.Text type="secondary">
          One generated video always covers all 4 facing directions at once, one per grid cell.
        </Typography.Text>
      </Space>
    </Card>
  )
